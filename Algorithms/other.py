...
def other(X_train,y_train,X_test,y_test,cpus,Identifier):
    '''
    ...
    if Identifier != "News":
        makeGraph(y_test,valueFromTimeSeries=prediction,name="Time Series - other")
    else:
        makeGraph(y_test,valueFromNews=prediction,name="News - other")
    print(prediction)
